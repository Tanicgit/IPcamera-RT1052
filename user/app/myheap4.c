...
/*8M 0X80000000~0X807fffff	SIZE=0X800000编译器静态分配*/
/*8M 0X80800000~0x81ffffff  SIZE=0X800000 staticMalloc 分配后不释放*/
/*16M 0x81000000~0x81ffffff  SIZE=0X1000000 用作动态分配*/

static uint32_t static_addr=0;
#define STATIC_SDRAM_ADDR		(SDRAM2_ADDR)
#define STATIC_SDRAM_SPACE	(SDRAM2_SIZE)//8M
...
//size_t uxAddress;
//size_t xTotalHeapSize = myConfigTOTAL_HEAP_SIZE;
